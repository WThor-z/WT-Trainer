"""Fine-tuning arguments for various training techniques and optimizers."""
...
class SwanLabArguments:
    """Arguments for configuring SwanLab experiment tracking."""
...
@dataclass
class BAdamArgument:
    """Arguments for configuring the BAdam optimizer."""
...
class FinetuningArguments(
    ...
    def __post_init__(self) -> None:
        ...
        self.apollo_target = split_arg(self.apollo_target)
